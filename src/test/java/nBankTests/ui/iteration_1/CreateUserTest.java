...
public class CreateUserTest {
    ...
    public void adminCanCreateUserTest() {
        ...
        $(byAttribute("placeholder", "Username")).sendKeys(newUser.getUsername());
        $(byAttribute("placeholder", "Password")).sendKeys(newUser.getPassword());
        ...
        ElementsCollection allUsersFromDashboard = $(byText("All Users")).parent().findAll("li");
